...
<div class="container" id="page">
	<div id="topnav">
		...
		<div class="topnav_text"><a href='/tesk24/index.php?r=site/index'>Home</a> | <a href='/tesk24/index.php?r=site/login'>Login</a></div>
		<?php elseif (!Yii::app()->user->isGuest): ?>
		<div class="topnav_text"><a href='/tesk24/index.php?r=site/index'>Home</a> | <a href='/tesk24/index.php?r=site/logout'>Logout (<?= Yii::app()->user->name ?>)</a></div>
		<?php endif; ?>
	</div>
	<div id="header">
...
<?php /*$this->widget('application.extensions.mbmenu.MbMenu',array(
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Data User', 'url'=>array('/site/page', 'view'=>'data_user')),
				array('label'=>'Pendaftaran Member', 'url'=>array('/member/create')),
	...
	<div id="footer">
		&copy; <?php echo date('Y'); ?> Galang - All Rights Reserved.
	</div><!-- footer -->
